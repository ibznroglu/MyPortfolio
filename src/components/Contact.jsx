    ...
    <div className="w-full section-shell bg-gradient-to-b from-[#112240] to-[#0a192f] flex items-center justify-center py-12">
      <div className="max-w-2xl mx-auto px-8 w-full">
        ...
        <form
          ...
          className="bg-[#112240] p-6 rounded-xl border border-white/5 shadow-2xl space-y-4"
        >
          <input
            className="w-full bg-[#0a192f] border border-pink-600/30 text-gray-300 p-3 rounded-lg focus:outline-none focus:border-pink-600 focus:ring-2 focus:ring-pink-600/50 transition-all"
            type="text"
          ...
          <button
            type="submit"
            className="w-full text-white border-2 border-pink-600 bg-pink-600 hover:bg-pink-500 hover:border-pink-500 px-8 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-pink-600/50 font-semibold"
          >
            {t.contact.send}
          </button>
        </form>
